    ...
    <>
      ...
      <div className="bg-gray-100 py-12">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-8">
          ...
          <div className="grid grid-cols-2 items-baseline auto-rows-[minmax(0,auto)] gap-8">
          ...
          <div className="bg-white  h-auto rounded-lg  min-h-[unset]  shadow-md p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <input
                    ...
                    className={`bg-gray-100 border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#002244] focus:border-[#002244] ${
              ...
              <button
                type="submit"
                className="bg-[#002244] mt-16 hover:bg-[#334e69] text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-[#002244] focus:ring-opacity-50"
              >
                Submit
              </button>
...
<div class="bg-gray-100 p-8 py-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <h2 class="text-5xl  text-center  font-bold text-gray-900 mb-12 ">As feautured in ...</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      <div>
        <a href="#">
        <img src={Logo6} alt="" class="h-12 w-auto" />

        </a>
      </div>
      <div>
        <a href="#">
        <img src={Logo7} alt="" class="h-12 w-auto" />

        </a>
      </div>
      <div>
        <a href="#">
        <img src={Logo8} alt="" class="h-12 w-auto" />

        </a>
      </div>
      <div>
        <a href="#">
        <img src={Logo9} alt="" class="h-12 w-auto" />
...
<div class="bg-[#1a3857] py-12 px-4 sm:px-6 lg:px-8">
  <div class="flex justify-center  mx-auto">
    <div class="text-white font-bold text-2xl mx-6 mb-6">Validate a student's qualification. Enter their certificate ID to begin.</div>
   
    <div class="relative flex">
    <input type="search" placeholder="Enter certificate ID" class="w-full bg-transparent border
     border-white rounded-md py-3 pl-4 pr-12
      text-white placeholder:text-white focus:outline-none
       focus:ring-2 focus:ring-[#002244] focus:border-white sm:text-sm" />
